...
public class Main {
    ...
    private static Thread[] getMinPriority(int quantity, int startingPoint) {
        ...
        for (int i = startingPoint; i < startingPoint + quantity; i++) {
            threads[i - startingPoint] = new Fibonacci("Fil " + i, random.nextInt(10), Thread.MIN_PRIORITY);
        }
    ...
    private static Thread[] getMaxPriority(int quantity, int startingPoint) {
        ...
        for (int i = startingPoint; i < startingPoint + quantity; i++) {
            threads[i - startingPoint] = new Fibonacci("Fil " + i, random.nextInt(10), Thread.MAX_PRIORITY);
        }
